...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        } //used count instead of contains, because the genres are a list, not a string.
        ...
        }//first gets the first item from an inumerable. 
        ...
        {
            return shows.Count(s => s.ImdbRating > 7);
        }
